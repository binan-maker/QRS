...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 18, fontFamily: "Inter_700Bold", marginBottom: 8, textAlign: "center" },
  ...
  para: { fontSize: 13, fontFamily: "Inter_400Regular", lineHeight: 20, marginBottom: 10 },
  ...
  genLabel: { fontSize: 13, fontFamily: "Inter_600SemiBold", marginBottom: 4 },
