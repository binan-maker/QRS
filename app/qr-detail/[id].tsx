        ...
        <View style={[styles.container, { paddingTop: topInset }]}>
          ...
          >
            ...
            {!q.ownerInfo?.isBranded && !q.offlineMode && (
              <Animated.View entering={FadeInDown.duration(300).delay(75)}>
                <View style={[externalQrBannerStyles.card, { backgroundColor: colors.surface, borderColor: colors.warning + "50", borderLeftColor: colors.warning, borderLeftWidth: 3 }]}>
                  <View style={externalQrBannerStyles.iconRow}>
                    <View style={[externalQrBannerStyles.iconWrap, { backgroundColor: colors.warning + "18", borderColor: colors.warning + "40" }]}>
                      <Ionicons name="alert-circle-outline" size={20} color={colors.warning} />
                    </View>
                    <View style={{ flex: 1 }}>
                      <Text style={[externalQrBannerStyles.title, { color: colors.warning }]}>Standard QR — Owner Unverified</Text>
                      <Text style={[externalQrBannerStyles.body, { color: colors.textSecondary }]}>
                        This QR code was not generated by QR Guard. We can only check community reports — we{" "}
                        <Text style={{ fontFamily: "Inter_700Bold", color: colors.text }}>cannot verify who owns it</Text>
                        {" "}or guarantee safety. Proceed with caution.
                      </Text>
                    </View>
                  </View>
                  <View style={[externalQrBannerStyles.tipRow, { borderTopColor: colors.surfaceBorder }]}>
                    <Ionicons name="shield-checkmark-outline" size={12} color={colors.primary} />
                    <Text style={[externalQrBannerStyles.tipText, { color: colors.textMuted }]}>
                      Only QR Guard Verified QRs carry a guaranteed identity check
                    </Text>
                  </View>
                </View>
              </Animated.View>
            ...
            <Animated.View entering={FadeInDown.duration(400).delay(80)}>
              ...
              <TrustScoreCard
                ...
                isExternal={!q.ownerInfo?.isBranded}
              />
            </Animated.View>
