...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 18, fontFamily: "Inter_700Bold", textAlign: "center", letterSpacing: -0.3 },
  ...
  scoreBandLabel: { fontSize: 14, fontFamily: "Inter_700Bold" },
  rangeTag: { borderRadius: 8, paddingHorizontal: 8, paddingVertical: 3, borderWidth: 1 },
  rangeTagText: { fontSize: 12, fontFamily: "Inter_700Bold" },
  ...
  factorNumText: { fontSize: 12, fontFamily: "Inter_700Bold" },
  factorIcon: { width: 38, height: 38, borderRadius: 12, alignItems: "center", justifyContent: "center", flexShrink: 0 },
  factorTitle: { fontSize: 13, fontFamily: "Inter_600SemiBold", marginBottom: 3 },
