...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 13, fontFamily: "Inter_700Bold", textAlign: "center", letterSpacing: -0.2 },
  heroSub: { fontSize: 11, fontFamily: "Inter_400Regular", textAlign: "center", lineHeight: 16 },
  heroBadge: {
  ...
  sectionCardTitle: { fontSize: 12, fontFamily: "Inter_700Bold" },
  para: { fontSize: 12, fontFamily: "Inter_400Regular", lineHeight: 18, marginBottom: 5 },
  warnBox: {
    flexDirection: "row", alignItems: "flex-start", gap: 8,
    padding: 9, borderRadius: 10, borderWidth: 1, marginBottom: 7,
  },
  warnText: { fontSize: 11, fontFamily: "Inter_600SemiBold", flex: 1, lineHeight: 16 },
  scoreBand: {
    flexDirection: "row", alignItems: "flex-start", gap: 10,
    borderRadius: 14, padding: 11, marginBottom: 7, borderWidth: 1,
  },
  scoreBandIcon: { width: 34, height: 34, borderRadius: 10, alignItems: "center", justifyContent: "center", flexShrink: 0 },
  scoreBandLabel: { fontSize: 12, fontFamily: "Inter_700Bold" },
  rangeTag: { borderRadius: 7, paddingHorizontal: 6, paddingVertical: 2, borderWidth: 1 },
  rangeTagText: { fontSize: 10, fontFamily: "Inter_700Bold" },
  scoreBandDesc: { fontSize: 11, fontFamily: "Inter_400Regular", lineHeight: 16 },
  factorRow: {
    flexDirection: "row", alignItems: "flex-start", gap: 10,
    paddingVertical: 9, borderBottomWidth: 1,
  },
  factorNum: { width: 20, height: 20, borderRadius: 6, alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: 1 },
  factorNumText: { fontSize: 10, fontFamily: "Inter_700Bold" },
  factorIcon: { width: 30, height: 30, borderRadius: 9, alignItems: "center", justifyContent: "center", flexShrink: 0 },
  factorTitle: { fontSize: 12, fontFamily: "Inter_600SemiBold", marginBottom: 2 },
  factorDesc: { fontSize: 11, fontFamily: "Inter_400Regular", lineHeight: 16 },
  ...
  ctaIconWrap: { width: 38, height: 38, borderRadius: 12, alignItems: "center", justifyContent: "center", flexShrink: 0 },
  ctaTitle: { fontSize: 12, fontFamily: "Inter_700Bold", marginBottom: 2 },
  ctaSub: { fontSize: 11, fontFamily: "Inter_400Regular", lineHeight: 16 },
