...
export default function VerifyEmailScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
        <View style={[styles.orb, { backgroundColor: colors.primaryDim, borderColor: colors.primary + "30" }]}>
        ...
        {(resendSuccess || resendError) ? (
          <View
            style={[
              styles.banner,
              {
                backgroundColor: resendSuccess ? colors.safeDim : colors.dangerDim,
                borderColor: resendSuccess ? colors.safe + "40" : colors.danger + "40",
                marginBottom: sp(16),
              },
            ]}
          >
        ...
        <Pressable
          ...
          style={({ pressed }) => [
            styles.primaryBtn,
            {
              ...
              opacity: pressed || checkingVerification ? 0.88 : 1,
        ...
        >
          {checkingVerification ? (
            ...
            <>
              ...
              <Text style={[styles.primaryBtnText, { fontSize: sp(14) }]}>I've verified my email</Text>
            </>
          )}
        </Pressable>
        ...
        <Pressable
          ...
          style={({ pressed }) => [
            styles.outlineBtn,
            {
              ...
              paddingVertical: sp(13),
              opacity: pressed || resending || cooldown > 0 ? 0.7 : 1,
              transform: [{ scale: pressed ? 0.98 : 1 }],
            },
          ]}
        >
        ...
        <Pressable onPress={handleSignOut} hitSlop={8} style={[styles.linkBtn, { marginTop: sp(8) }]}>
          <Text style={[styles.linkText, { color: colors.textMuted, fontSize: sp(13) }]}>
