// Compact format: "just now", "5m ago", "2h ago", "3d ago", then falls back to short date.
// Use this for tight spaces like list rows, badges, and modals.
...
// Verbose format: "just now", "5 minutes ago", "2 hours ago", "3 days ago".
// Use this for full descriptions (notifications, detail screens).
