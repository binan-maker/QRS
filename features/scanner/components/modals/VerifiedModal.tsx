...
const styles = StyleSheet.create({
  ...
  sheet: {
    ...
    width: "100%", overflow: "hidden", gap: 20, paddingBottom: 28,
  },
  accentStripe: {
    width: "100%", height: 3, backgroundColor: SAFE_COLOR,
  ...
  checkBadge: {
    ...
    backgroundColor: SAFE_COLOR, alignItems: "center", justifyContent: "center",
    borderWidth: 2, borderColor: "rgba(16,25,41,0.98)",
  },

  textGroup:  { alignItems: "center", gap: 8, paddingHorizontal: 24 },
  eyebrow:    { fontSize: 11, fontFamily: "Inter_700Bold", color: SAFE_COLOR, letterSpacing: 2.5 },
  ...
  ownerName:  { fontFamily: "Inter_700Bold", color: SAFE_COLOR },
  ...
  trustBadgeText:   { fontSize: 12, fontFamily: "Inter_600SemiBold", color: SAFE_COLOR },
  trustBadgeDivider:{ width: 1, height: 14, backgroundColor: "rgba(34,197,94,0.2)" },

  redirectRow: { flexDirection: "row", alignItems: "center", gap: 7 },
  redirectDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: SAFE_COLOR, opacity: 0.7 },
  redirectText:{ fontSize: 13, fontFamily: "Inter_400Regular" },

  bottomMark:     { flexDirection: "row", alignItems: "center", gap: 5 },
  bottomMarkText: {
