...
export function makeStyles(c: AppColors) {
  return StyleSheet.create({
    ...
    emptyComments: { alignItems: "center", paddingVertical: 28, gap: 6 },
    emptyCommentsText: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: c.textSecondary },
    emptyCommentsSub: { fontSize: 11, fontFamily: "Inter_400Regular", color: c.textMuted },
    commentsList: { gap: 4 },
    commentBlock: {
    ...
    inputAvatarText: { fontSize: 12, fontFamily: "Inter_700Bold", color: c.primary },
    commentInput: {
      flex: 1, borderRadius: 20,
      paddingHorizontal: 13, paddingVertical: 8, fontSize: 13, fontFamily: "Inter_400Regular",
