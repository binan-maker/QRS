...
export function makeStyles(c: AppColors) {
  return StyleSheet.create({
    ...
    signInToCommentText: { fontSize: 13, fontFamily: "Inter_500Medium", color: c.text, flex: 1 },
    noComments: {
    ...
    noCommentsText: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: c.textSecondary },
    noCommentsSubtext: { fontSize: 12, fontFamily: "Inter_400Regular", color: c.textMuted },
    loadMoreBtn: {
      backgroundColor: c.surface, borderRadius: 14, padding: 12, alignItems: "center",
      borderWidth: 1, borderColor: c.surfaceBorder, marginTop: 6, marginBottom: 10,
    },
    loadMoreText: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: c.primary },
    ...
    replyBanner: {
      ...
      marginBottom: 8, borderWidth: 1, borderColor: c.primary + "20",
    },
    replyBannerText: { flex: 1, fontSize: 12, fontFamily: "Inter_400Regular", color: c.textSecondary },
    ...
    commentTextInput: {
      ...
      paddingHorizontal: 14, paddingVertical: 9, maxHeight: 80,
      borderWidth: 1, borderColor: c.surfaceBorder,
    },
    sendBtn: {
