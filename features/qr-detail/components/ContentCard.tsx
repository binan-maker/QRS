...
const TYPE_CONFIG: Record<string, {
  ...
  url:      { icon: "globe-outline",       label: "URL",              gradient: ["#006FFF", "#00CFFF"], openLabel: "Open Link" },
  phone:    { icon: "call-outline",        label: "Phone Number",     gradient: ["#10B981", "#06B6D4"], openLabel: "Call Number" },
  email:    { icon: "mail-outline",        label: "Email",            gradient: ["#8B5CF6", "#EC4899"], openLabel: "Send Email" },
  wifi:     { icon: "wifi-outline",        label: "Wi-Fi Network",    gradient: ["#3B82F6", "#6366F1"], openLabel: "Connect to Wi-Fi" },
  location: { icon: "location-outline",    label: "Location",         gradient: ["#EF4444", "#F97316"], openLabel: "Open in Maps" },
  payment:  { icon: "card-outline",        label: "Payment",          gradient: ["#F59E0B", "#F97316"], openLabel: "Open Payment" },
  sms:      { icon: "chatbubble-outline",  label: "SMS Message",      gradient: ["#06B6D4", "#3B82F6"], openLabel: "Send SMS" },
  contact:  { icon: "person-outline",      label: "Contact Card",     gradient: ["#10B981", "#3B82F6"], openLabel: "Save Contact" },
  event:    { icon: "calendar-outline",    label: "Calendar Event",   gradient: ["#F59E0B", "#EF4444"], openLabel: "Add to Calendar" },
  otp:      { icon: "lock-closed-outline", label: "OTP / 2FA Setup",  gradient: ["#6366F1", "#8B5CF6"], openLabel: "Open Authenticator" },
  app:      { icon: "apps-outline",        label: "App Link",         gradient: ["#06B6D4", "#6366F1"], openLabel: "Open App" },
  social:   { icon: "people-outline",      label: "Social Profile",   gradient: ["#EC4899", "#8B5CF6"], openLabel: "Open Profile" },
  media:    { icon: "play-circle-outline", label: "Media",            gradient: ["#EF4444", "#EC4899"], openLabel: "Play Media" },
  document: { icon: "document-outline",    label: "Document",         gradient: ["#6B7280", "#9CA3AF"], openLabel: "Open Document" },
  boarding: { icon: "airplane-outline",    label: "Boarding Pass",    gradient: ["#006FFF", "#6366F1"], openLabel: "View Boarding Pass" },
  product:  { icon: "barcode-outline",     label: "Product",          gradient: ["#10B981", "#F59E0B"], openLabel: "View Product" },
  text:     { icon: "document-text-outline", label: "Text",           gradient: ["#6B7280", "#9CA3AF"], openLabel: "Open" },
};
