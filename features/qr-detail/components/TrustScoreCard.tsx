...
const styles = StyleSheet.create({
  ...
  scoreLabelBadge: { alignSelf: "flex-start", paddingHorizontal: 10, paddingVertical: 5, borderRadius: 100, borderWidth: 1 },
  scoreLabelText: { fontSize: 12, fontFamily: "Inter_700Bold", letterSpacing: 0.3 },
  ...
  breakdownLabel: { fontSize: 13, fontFamily: "Inter_500Medium", flex: 1 },
