    ...
    >
      ...
      >
        ...
        <View style={styles.topRow}>
          ...
          {m.badge ? (
            <View style={[styles.badge, { backgroundColor: m.badgeColor + "30", borderColor: m.badgeColor + "60" }]}>
...
const styles = StyleSheet.create({
  ...
  cardGlow:    { position: "absolute", top: -40, right: -40, width: 130, height: 130, borderRadius: 65, backgroundColor: "rgba(255,255,255,0.07)" },
  topRow:      { flexDirection: "row", alignItems: "center", gap: 12, marginBottom: 16 },
  iconWrap:    { width: 56, height: 56, borderRadius: 18, backgroundColor: "rgba(255,255,255,0.18)", alignItems: "center", justifyContent: "center", flexShrink: 0 },
