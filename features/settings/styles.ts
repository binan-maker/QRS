...
export function makeSettingsStyles(c: AppColors) {
  return StyleSheet.create({
    ...
    sectionLabel: {
      ...
      letterSpacing: 1.4, marginBottom: 10, paddingLeft: 4, textTransform: "uppercase",
    },
    menuGroup: {
    ...
    menuSublabel: { fontSize: 12, fontFamily: "Inter_400Regular", color: c.textSecondary, marginTop: 1 },
    divider: { height: StyleSheet.hairlineWidth, backgroundColor: c.surfaceBorder, marginLeft: 66 },
    ...
    accountName: { fontSize: 15, fontFamily: "Inter_700Bold", color: c.text },
    accountEmail: { fontSize: 12, fontFamily: "Inter_400Regular", color: c.textSecondary, marginTop: 2 },

    profileCard: {
      flexDirection: "row", alignItems: "center", gap: 14,
      borderRadius: 20, borderWidth: 1, borderColor: c.surfaceBorder,
      backgroundColor: c.surface, padding: 18, marginBottom: 28,
    },
    profileAvatarRing: {
    ...
    profileAvatarText: { fontSize: 22, fontFamily: "Inter_700Bold", color: c.primary },
    profileName: { fontSize: 16, fontFamily: "Inter_700Bold", color: c.text },
    profileEmail: { fontSize: 13, fontFamily: "Inter_400Regular", color: c.textSecondary, marginTop: 2 },
    verifiedBadge: {
    ...
    signInTitle: { fontSize: 15, fontFamily: "Inter_700Bold", color: c.text },
    ...
    footerVersion: { fontSize: 12, fontFamily: "Inter_400Regular", color: c.textMuted },
    footerText: { fontSize: 12, fontFamily: "Inter_400Regular", color: c.textMuted },
    footerSubtext: { fontSize: 11, fontFamily: "Inter_400Regular", color: c.textMuted },
    ...
    guideStepTitle: { fontSize: 15, fontFamily: "Inter_700Bold", color: c.text, marginBottom: 4 },
