import type { PaymentAppId, ParsedPaymentQr } from "@/services/analysis/types";
...
export function resolveIFSCBankName(ifsc: string): string {
  ...
  const MAP: Record<string, string> = {
    ...
    ABNA: "ABN AMRO / RBS India",
    ICBK: "ICBC India",
    SMBC: "Sumitomo Mitsui Banking",
    MHCB: "Mizuho Bank India",
    ...
    SHBK: "Sutlej Gramin Bank",
    ANDG: "Andhra Pradesh Gramin Vikas Bank",
    CGGB: "Chhattisgarh Rajya Gramin Bank",
    DRGB: "Dakshin Bihar Gramin Bank",
    GHBK: "Gujarat State Co-op Bank",
    HDFC_RRB: "HDFC RRB",
    JKGB: "J&K Grameen Bank",
    JKGO: "J&K Grameen Bank",
    KCCB: "Kashi Gomti Samyut Gramin Bank",
    KGGB: "Kaveri Grameena Bank",
    KJGB: "Kerala Gramin Bank",
    KLGB: "Kerala Gramin Bank",
    KMBK: "Kallappanna Awade Ichalkaranji Janata Sahakari Bank",
    MDBK: "Madhya Pradesh Gramin Bank",
    ...
    PCBL: "Punjab & Sind Bank Gramin",
    PLGB: "Pallavan Grama Bank",
    PMEC: "Puduvai Bharathiar Grama Bank",
    PRAGB: "Pragathi Krishna Gramin Bank",
    PRAGK: "Pragathi Krishna Gramin Bank",
    PKGB: "Pragathi Krishna Gramin Bank",
    PUCB: "Pune District Central Co-op Bank",
    RRBP: "Rajasthan Marudhara Gramin Bank",
    SBKK: "Saurashtra Gramin Bank",
    SGBA: "Saurashtra Gramin Bank",
    SGRB: "Sarva UP Gramin Bank",
    SPGB: "Saptagiri Gramin Bank",
    SSCB: "Saraswat Co-op Bank",
    TGGB: "Tripura Gramin Bank",
    TNGB: "Tamil Nadu Grama Bank",
    UTGB: "Uttarakhand Gramin Bank",
    VGBS: "Vidarbha Konkan Gramin Bank",
    ...
    APMC: "Andhra Pradesh Mahesh Co-op Urban Bank",
    BDBL: "Bandhan Bank",
    BKBK: "Bandhan Bank",
    BDCB: "Bandhan Bank",
    BFIN: "Bajaj Finance",
