...
export const styles = StyleSheet.create({
  card: { borderRadius: 22, padding: 16, marginBottom: 12, borderWidth: 1, overflow: "hidden", gap: 11 },
  ...
  secDot: { position: "absolute", bottom: 0, right: 0, width: 16, height: 16, borderRadius: 8, alignItems: "center", justifyContent: "center", borderWidth: 1.5, borderColor: "#0F172A" },
  ...
  protoBadge: { flexDirection: "row", alignItems: "center", gap: 4, paddingHorizontal: 7, paddingVertical: 3, borderRadius: 6, borderWidth: 1 },
  ...
  copyBtn: { flexDirection: "row", alignItems: "center", gap: 4, height: 30, paddingHorizontal: 10, borderRadius: 9, borderWidth: 1, flexShrink: 0 },
  copyText: { fontSize: 11, fontFamily: "Inter_600SemiBold" },
  urlStrip: { flexDirection: "row", alignItems: "center", gap: 9, borderRadius: 12, paddingVertical: 10, paddingHorizontal: 12, borderWidth: 1 },
  ...
  detailsToggle: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderRadius: 11, paddingHorizontal: 12, paddingVertical: 9, borderWidth: 1 },
  detailsLeft: { flexDirection: "row", alignItems: "center", gap: 6 },
  detailsToggleText: { fontSize: 12, fontFamily: "Inter_600SemiBold" },
  chipGroup: { flexDirection: "row", alignItems: "center", gap: 5 },
  ...
  detailsBox: { borderRadius: 13, paddingVertical: 4, paddingHorizontal: 12, borderWidth: 1, marginTop: 6 },
